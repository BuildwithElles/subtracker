...
- banner:
  ...
  - button "Logout":
    ...
    - text: Logout
- main:
  - heading "Good afternoon, Demo User! 👋" [level=2]
  ...
  - text: Monthly Income $0.00 Fixed Expenses -$0.00 Subscriptions -$0.00 Discretionary $0.00 Remaining Budget $0.00 Daily Safe to Spend • Budget Exceeded $0.00 25 days left this month
