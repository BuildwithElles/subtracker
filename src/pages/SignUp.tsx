    ...
    try {
      ...
      if (error) {
        ...
        if (data.user.email_confirmed_at) {
          // User is immediately confirmed - proceed to onboarding
          ...
          setErrors({
            general:
              'Please check your email and click the confirmation link to complete your registration. Then you can sign in.',
          })
        }
      }
    } catch (error: any) {
          ...
          <div className="space-y-4">
            ...
            {!isLoginMode && (
              <div>
                ...
                />
                {errors.referrerCode && (
                  <p className="mt-1 text-sm text-red-600">{errors.referrerCode}</p>
                )}
              </div>
            )}
          </div>
