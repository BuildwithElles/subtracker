...
test.describe('SubTracker - Core Functionality Tests', () => {
  ...
  test('Navigation to signup page works', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="referrer-code-input"]')).toBeVisible()
  ...
  test('Signup form has all required fields and functionality', async ({ page }) => {
    ...
    await page.fill('[data-testid="referrer-code-input"]', 'test123')
    const referrerValue = await page.inputValue('[data-testid="referrer-code-input"]')
  ...
  test('Gmail scan button is functional', async ({ page }) => {
    ...
    const gmailButton = page
      .locator('text=Connect Gmail')
      .or(page.locator('text=Scan Gmail'))
      .or(page.locator('text=Gmail Integration'))
  ...
  test('Logout functionality works', async ({ page }) => {
    ...
    if (await logoutElement.first().isVisible()) {
      ...
      const loggedOut = await Promise.race([
        ...
        page
          .locator('text=SubTracker')
          .and(page.locator('text=Track your subscriptions'))
          .isVisible(),
        page
          .waitForURL('**/')
          .then(() => true)
