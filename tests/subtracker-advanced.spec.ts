...
async function setupBudgetProfile(page: Page, budget: typeof mockBudget) {
...
async function addSubscription(page: Page, subscription: typeof mockSubscription) {
...
test.describe('SubTracker Advanced Features', () => {
  ...
  test.describe('Integration Tests', () => {
    test('Complete user flow: signup -> add budget -> add subscription -> view insights', async ({ page }) => {
